                        ...
                        <div className="col-lg-3">
                            ...
                            <div className="card shadow-0 border">
                                <div className="card-body">
                                    ...
                                    <div className="mt-3">
                                        <Link href="/checkout" className="btn btn-primary w-100 shadow-0 mb-2"> Make Purchase </Link>
                                        <Link href="/accessories" className="btn btn-light w-100 border mt-2"> Back to shop </Link>
                                    </div>
                                </div>
                            </div>
                        </div>
