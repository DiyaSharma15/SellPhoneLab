...
export default function Checkout() {
  ...
  const publishableKey = `${process.env.NEXT_PUBLIC_SCRET}`;
              ...
              <div className="p-4">
                ...
                <div className="float-end">
                  ...
                  <button
                    ...
                    className="ml-2 btn btn-success shadow-0 border"
                  >
                    Continue
                  </button>
                </div>
              ...
              {cart?.cartItems?.length > 0 && (
                <div>
                  {cart?.cartItems?.map(
                    (
                      cartItem,
                      index // Assuming cartItem has a unique identifier, e.g., cartItem.id
                    ) => (
                      <div
