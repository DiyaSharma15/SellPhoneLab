      ...
      <div className="row gx-5">
        <aside className="col-lg-6">
          <div className="border rounded-4 mb-3 d-flex justify-content-center">
            <div data-fslightbox="mygalley" className="rounded-4" target="_blank">
              <img style={{maxWidth: "100%", maxHeight: "100vh", margin: "auto"}} className="rounded-4 fit" src="https://sellphonelab.ca/wp-content/uploads/2022/10/arm-band.jpg" />
            </div>
          </div>
          <div className="d-flex justify-content-center mb-3">
            <button data-fslightbox="mygalley" className="border mx-1 rounded-2" target="_blank" >
        ...
        <main className="col-lg-6">
          <div className="ps-lg-3">
            ...
            <div className="d-flex flex-row my-3">
              ...
              <span className="text-muted"><MdShoppingBasket/> 154 orders</span>
            ...
            <Link href="/cart" className="btn btn-primary shadow-0"> <MdShoppingBag/> Add to cart </Link>
